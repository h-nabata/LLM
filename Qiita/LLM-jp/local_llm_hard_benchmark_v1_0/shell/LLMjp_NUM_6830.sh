...
curl -sS http://127.0.0.1:8080/v1/chat/completions \
  ...
  --data-binary @- <<'JSON' | python3 -m json.tool > SP-NUM-P01_LLMjp.log
{
  "messages": [
    {
      "role": "user",
...
curl -sS http://127.0.0.1:8080/v1/chat/completions \
  -H 'Content-Type: application/json' \
  --data-binary @- <<'JSON' | python3 -m json.tool > SP-NUM-P02_LLMjp.log
{
  "messages": [
    {
      "role": "user",
...
curl -sS http://127.0.0.1:8080/v1/chat/completions \
  -H 'Content-Type: application/json' \
  --data-binary @- <<'JSON' | python3 -m json.tool > SP-NUM-P03_LLMjp.log
{
  "messages": [
    {
      "role": "user",
...
curl -sS http://127.0.0.1:8080/v1/chat/completions \
  -H 'Content-Type: application/json' \
  --data-binary @- <<'JSON' | python3 -m json.tool > SP-NUM-P04_LLMjp.log
{
  "messages": [
    {
      "role": "user",
...
curl -sS http://127.0.0.1:8080/v1/chat/completions \
  -H 'Content-Type: application/json' \
  --data-binary @- <<'JSON' | python3 -m json.tool > SP-NUM-P05_LLMjp.log
{
  "messages": [
    {
      "role": "user",
...
curl -sS http://127.0.0.1:8080/v1/chat/completions \
  -H 'Content-Type: application/json' \
  --data-binary @- <<'JSON' | python3 -m json.tool > SP-NUM-P06_LLMjp.log
{
  "messages": [
    {
      "role": "user",
...
curl -sS http://127.0.0.1:8080/v1/chat/completions \
  -H 'Content-Type: application/json' \
  --data-binary @- <<'JSON' | python3 -m json.tool > SP-NUM-P07_LLMjp.log
{
  "messages": [
    {
      "role": "user",
...
curl -sS http://127.0.0.1:8080/v1/chat/completions \
  -H 'Content-Type: application/json' \
  --data-binary @- <<'JSON' | python3 -m json.tool > SP-NUM-P08_LLMjp.log
{
  "messages": [
    {
      "role": "user",
